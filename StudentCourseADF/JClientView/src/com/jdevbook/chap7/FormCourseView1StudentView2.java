...
public class FormCourseView1StudentView2 extends JFrame 
{
  // form layout
...
// the statusbar
  ...
  private MDPanelCourseView1StudentView2 dataPanel = new MDPanelCourseView1StudentView2();
...
// menu definitions
  ...
  public static void main(String [] args)
  {
    ...
    try
    {
      ...
      DCDataControl app = (DCDataControl)ctx.get("com_jdevbook_chap7_model_AppModuleDataControl");
      app.setClientApp(DCDataControl.JCLIENT);
      app.getApplicationModule().fetchAttributeProperties(new String[] {"CourseView1", "StudentView2"}, new String[][] {{"CourseId", "CourseName"}, {"StudentId", "StudentName", "CourseId"}}, null);
      FormCourseView1StudentView2 frame = new FormCourseView1StudentView2();
  ...
  private void _popupTransactionDialog()
  {
    ...
    if (panelBinding.isTransactionDirty())
    {
      ...
      int action = JOptionPane.showOptionDialog(FormCourseView1StudentView2.this, "How do you want to close the transaction?", "Transaction open", JOptionPane.YES_NO_OPTION, JOptionPane.INFORMATION_MESSAGE, null, options, options[0]);
   ...
   */
  public FormCourseView1StudentView2()
  {
