...
{
var a12=a0.createTextRange();
a12.moveStart("character",window["_failedPos"]);
a12.select();
}
...
var a13=_getErrorString(a0,a2,
a11);
if(a13)
{
_validationAlert(a13);
}
if(a5&&(a0.type!='hidden'))
{
a0.focus();
...
if(!a0)
return false;
var a3=window["_"+a0.name+"Validater"];
if(a3==(void 0))
{
_saveForm=a0;
_saveDoValidate=a1;
_saveParameters=a2;
if(a0.target=="_pprIFrame")
{
...
{
var a14=document.createElement("input");
a14.type="hidden";
a14.name=a11;
a14.value=a2[a11];
a0.appendChild(a14);
...
{
parent.window.execScript(_pprLibStore.allLibraries[a2]);
}
_pprLibStore=null;
}
}
...
{
var a2=_getElementById(a0,"_pprIFrame");
if(a2)
{
...
_saveScripts(a2);
_pprStopBlocking(parent);
var a11=_getRequestedFocusNode();
if(a11!=null)
a4=a11;
...
var a2=_getElementById(a0.document,_pprdivElementName);
if(a2)
{
if(_agent.isGecko)
{
var a3=a1.offsetWidth+16;
var a4=a1.offsetHeight;
a2.style.height=a4;
a2.style.width=a3;
if(top._pprBlockingTimeout!=null)
{
top.clearTimeout(top._pprBlockingTimeout);
}
top._pprBlockingTimeout=top.setTimeout("_pprStopBlocking(window);",
8000);
}
else if(_agent.isIE)
{
...
a2.focus();
top._pprSavedCursor=a1.style.cursor;
a1.style.cursor="wait";
}
...
if(a0._pprBlocking)
{
var a1=_getElementById(a0.document,_pprdivElementName);
if(_agent.isGecko)
{
a1.style.width=0;
a1.style.height=0;
...
a0.document.body.style.cursor=top._pprSavedCursor;
}
...
return true;
var a0=false;
if((!top._pprBlocking)&&(_pprChoiceChanged))
{
...
if(a0==null)
return;
var a1=_getElementById(document,"_pprSavePage");
if(a1==null)
return;
a1.value=a0.outerHTML;
}
...
var a2=_getElementById(document,"_pprSaveLib");
if(a2!=null&&a2.value!="")
{
var a3=a2.value.split(",");
_loadScriptLibrariesIE(document,a3);
}
...
case'z':
{
var a15=a5.getTimezoneOffset()/60;
a7="GMT";
if(a15>0)a7+="+";
...
{
if(a0[a3].indexOf('MMM')!=-1)
{
a0[a0.length]=a0[a3].replace(/MMM/g,'MM');
a0[a0.length]=a0[a3].replace(/MMM/g,'M');
}
}
var a2=a0.length;
for(var a3=0;a3<a2;a3++)
